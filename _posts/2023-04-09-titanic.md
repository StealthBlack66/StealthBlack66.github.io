...
![StealthBlack66.github.io](./train_data.head().png)
...
![StealthBlack66.github.io](./train_data.describe().png)
...
![StealthBlack66.github.io](./from sklearn.ensemble import RandomForestClassifier.png)
...
![StealthBlack66.github.io](./train_data.png)

    train_data["RelativesOnboard"] = train_data["SibSp"] + train_data["Parch"]
    train_data[["RelativesOnboard", "Survived"]].groupby(
        ['RelativesOnboard']).mean()
        
![StealthBlack66.github.io](./막.png)
